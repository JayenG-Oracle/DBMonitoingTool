This repository contains a set of shell scripts that provide menu-driven SQL options for monitoring DBA activities for Oracle databases version 12c and above, including multitenant databases.
